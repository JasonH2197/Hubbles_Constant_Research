...
outdir = '/home/jason/Bilby/my_own_runs/bilby_run10/bilby_run_2.239_1.346/outdir' + '_' + str(luminosity_distance) + '_' + str(ra) + '_' + str(dec)
...
prior_dictionary = dict(
    ...
    dec=bilby.core.prior.DeltaFunction(peak=1.346),
    ra=bilby.core.prior.DeltaFunction(peak=2.239),
