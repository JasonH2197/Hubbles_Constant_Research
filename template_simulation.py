...
psi=0
phase=1.0
ra = 4.85 # right ascension & declination (position)
dec = 0.0
...
outdir = 'path/to/outdir' + '_' + str(luminosity_distance) + '_' + str(ra) + '_' + str(dec)
...
likelihood = bilby.gw.likelihood.ROQGravitationalWaveTransient(
    ...
    priors=priors,
    linear_matrix="path/to/roq/.hdf5_file",
    quadratic_matrix="path/to/roq/.hdf5_file",
